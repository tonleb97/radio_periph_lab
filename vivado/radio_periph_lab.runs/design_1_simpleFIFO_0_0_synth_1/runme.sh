...
HD_PWD='D:/School/sysFPGAlab/radio_periph_lab/vivado/radio_periph_lab.runs/design_1_simpleFIFO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_simpleFIFO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_simpleFIFO_0_0.tcl
